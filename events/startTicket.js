...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.isButton() && interaction.customId === "start_ticket" || interaction.isButton() && interaction.customId === "start_ticket4" || interaction.isButton() && interaction.customId === "start_ticket5" || interaction.isButton() && interaction.customId === "start_ticket6") {
        ...
        if (interaction.isButton() && interaction.customId === "close_ticket") {
            ...
            if (!interaction.member.roles.cache.has(config.ticket.support_role)) return interaction.reply({
            ...
            interaction.reply({
                embeds: [
                    new Discord.EmbedBuilder()
                        .setColor(config.embeds_color.embed_invisible)
                        .setDescription(
                            `✅ | Painel vendas aberto com sucesso, escolha uma das opções abaixo:`
                        ),
                ],
                components: [
