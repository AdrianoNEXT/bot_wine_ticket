...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (interaction.isButton() && interaction.customId === "start_ticket3") {
            ...
            const description = new Discord.TextInputBuilder()
                ...
                .setMaxLength(255)
                .setStyle(2)
                .setPlaceholder('Lembrando que este ticket não é visivel para staffs, apenas para diretoria');
        ...
        if (interaction.isModalSubmit() && interaction.customId === "modal_ticket3") {
            ...
            const channel = await interaction.guild.channels.create({
                ...
                type: 0,
                parent: config.ticket.category_id3,
                permissionOverwrites: [
                    ...
                    {
                        id: config.ticket.support_role3,
                        allow: ["ViewChannel", "SendMessages", "AttachFiles", "AddReactions"]
                    }
                ],
            })
            ...
            channel.send({
                content: `||${interaction.user} - ${interaction.guild.roles.cache.get(config.ticket.support_role3)}||`,
                embeds: [
                    new Discord.EmbedBuilder()
                ...
                components: [new Discord.ActionRowBuilder()
                    .addComponents(
                        new Discord.ButtonBuilder()
                            ...
                            .setStyle(4),
                        new Discord.ButtonBuilder()
                            .setCustomId("painel_member3")
                            .setEmoji("👨‍💼")
                            .setLabel("Painel membro")
                            .setStyle(3),
                        new Discord.ButtonBuilder()
                            .setCustomId("painel_staff3")
                            .setEmoji("💼")
                            .setLabel("Painel staff")
                            .setStyle(1),
                        new Discord.ButtonBuilder()
                            .setCustomId("painel_sale3")
                            .setEmoji("🛒")
        ...
        if (interaction.isButton() && interaction.customId === "close_ticket3") {
            ...
            if (interaction.user.id !== user.id && !interaction.member.roles.cache.get(config.ticket.support_role3)) return interaction.reply({
                embeds: [
                    new Discord.EmbedBuilder()
                        .setColor(config.embeds_color.embed_error)
            ...
            interaction.update({
                ...
                components: [
                    new Discord.ActionRowBuilder()
                        .addComponents(
                            new Discord.ButtonBuilder()
                                .setCustomId("open_ticket3")
                                .setEmoji("🔓")
                                .setLabel("Abrir")
                                .setStyle(4),
                            new Discord.ButtonBuilder()
                                .setCustomId("delete_ticket3")
                                .setEmoji("🗑️")
                                .setLabel("Deletar")
                                .setStyle(4),
                            new Discord.ButtonBuilder()
        ...
        } else if (interaction.isButton() && interaction.customId === "open_ticket3") {
            const ticket = await db.get(`ticket_${interaction.channel.id}`);
        ...
        } else if (interaction.isButton() && interaction.customId === "painel_member3") {
            const ticket = await db.get(`ticket_${interaction.channel.id}`);
                    ...
                    new Discord.ActionRowBuilder()
                        .addComponents(
                            new Discord.StringSelectMenuBuilder()
                                .setCustomId('options_member3')
                                .setPlaceholder('Escolha uma opção!')
                                .addOptions(
                                    { label: '➕ Criar call', value: `create_call3` },
                                    { label: '🗑️ Deletar call', value: `delete_call3` },
                                    { label: '👤 Adicionar usuário', value: `add_user3` },
                                    { label: '🗑️ Remover usuário', value: `remove_user3` },
                                    { label: '💾 Salvar logs', value: `transcript3` }
                                )
                        )
                ],
                ephemeral: true
            })
        } else if (interaction.isStringSelectMenu() && interaction.customId === "options_member3") {
            const ticket = await db.get(`ticket_${interaction.channel.id}`);
            const user = await interaction.guild.members.cache.get(ticket.owner_id)

            const option = interaction.values[0];

            if (option === "create_call3") {
                ...
                const channel = await interaction.guild.channels.create({
                    ...
                    type: 2,
                    parent: config.ticket.category_call_id3,
                    permissionOverwrites: [
                        {
                            id: interaction.guild.id,
                            deny: ["ViewChannel"],
        ...
        } else if (interaction.isButton() && interaction.customId === "painel_staff3") {
            if (!interaction.member.roles.cache.get(config.ticket.support_role3)) return interaction.reply({
                embeds: [
                    new Discord.EmbedBuilder()
                        .setColor(config.embeds_color.embed_error)
            ...
            interaction.reply({
                ...
                components: [
                    new Discord.ActionRowBuilder()
                        .addComponents(
                            new Discord.StringSelectMenuBuilder()
                                .setCustomId('options_staff3')
                                .setPlaceholder('Escolha uma opção!')
                                .addOptions(
                                    { label: '🔔 Notificar usuário', value: `notify_user3` },
                                    { label: '💾 Salvar logs', value: `transcript3` },
                                    { label: '🗑️ Deletar ticket', value: `delete_ticket3` },
                                )
                        )
                ],
                ephemeral: true
            })
        } else if (interaction.isStringSelectMenu() && interaction.customId === "options_staff3") {
            const ticket = await db.get(`ticket_${interaction.channel.id}`);
            const user = await interaction.guild.members.cache.get(ticket.owner_id)

            const option = interaction.values[0];

            if (option === "notify_user3") {
                await user.send({
                    embeds: [
                        new Discord.EmbedBuilder()
                            .setColor(config.embeds_color.embed_invisible)
                ...
                const channel_send = interaction.guild.channels.cache.get(config.ticket.channel_logs3)
        ...
        } else if (interaction.isButton() && interaction.customId === "painel_sale3") {
            if (!interaction.member.roles.cache.has(config.ticket.support_role3)) return interaction.reply({
            ...
            interaction.reply({
                ...
                components: [
                    new Discord.ActionRowBuilder()
                        .addComponents(
                            new Discord.StringSelectMenuBuilder()
                                .setCustomId('options_sales3')
                                .setPlaceholder('Escolha uma opção!')
                                .addOptions(
                                    { label: '⭐ pix', value: `pix3` },
                                    { label: '💾 QRCODE', value: `qrcode3` },
                                )
                        )
                ],
                ephemeral: true
            })
        } else if (interaction.isStringSelectMenu() && interaction.customId === "options_sales3") {
            const option = interaction.values[0];
        ...
        } else if (interaction.isButton() && interaction.customId === "delete_ticket3") {
            const ticket = await db.get(`ticket_${interaction.channel.id}`);
